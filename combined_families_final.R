...
fam_location <- "/home/fbraddock/NAS/WGS/Analysis/SNV/results"
...
fams <- list.files(fam_location, full.names = TRUE, recursive = TRUE, pattern = "het_homo_exonic_snp")
...
write.csv(gene_dt, file="/home/fbraddock/NAS/WGS/Analysis/SNV/results/KC_Family_all/homo_het_shared_snv_genes.csv", row.names=FALSE)
